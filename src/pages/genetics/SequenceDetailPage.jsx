...
export default function SequenceDetailPage() {
  ...
  const tabs = [
    { key: "info", label: "Informasi", icon: Info },
    {
      ...
      label: "Mutasi",
      icon: Microscope,
      count: seq.protein_functions?.length ?? 0,
    },
    {
      key: "protein",
            ...
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              {seq.status_processed && (
                <span
                  className={clsx(
                    "badge",
                    STATUS_COLOR[seq.status_processed] || "badge-muted",
                  )}
                >
                  {seq.status_processed}
                </span>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10">
                ...
                <div>
                  ...
                  <InfoRow
                    label="Length"
                    value={seq.sequence_data?.length?.toLocaleString() + " bp"}
                  />
        ...
        {activeTab === "mutations" && (
          <div>
            ...
            <p className="text-sm text-[--text-secondary]">
              ...
              untuk daftar mutasi pada sekuens ini.
            </p>
          </div>
        )}
        ...
        {activeTab === "protein" && (
          <div>
            ...
            {!seq.protein_functions?.length ? (
              <p className="text-sm text-[--text-secondary]">
                Tidak ada data protein function.
              </p>
            ) : (
              <div className="space-y-2">
